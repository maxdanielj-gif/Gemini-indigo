...
import { MessageSquare, User, Brain, Image as ImageIcon, Book, Settings, Camera, Menu, X, BookOpen, History as HistoryIcon, RefreshCw, Mail, Mic, Map as MapIcon } from 'lucide-react';
...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/live', icon: Mic, label: 'Voice Chat (Live)', hide: !aiProfile.aiCanGenerateSpeech },
    ...
    { path: '/image-generator', icon: Camera, label: 'Generate Image', hide: !aiProfile.aiCanGenerateImages },
    { path: '/journal', icon: BookOpen, label: 'Journal' },
    { path: '/calendar', icon: Book, label: 'Calendar', hide: !aiProfile.aiCanUseCalendar },
    { path: '/map', icon: MapIcon, label: 'Map', hide: !aiProfile.aiCanUseGoogleMaps },
